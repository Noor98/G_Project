...
<head>
	...
	<title>Contact Us - Alcazar</title>
		...
		<div class="container-fluid no-padding">
			<div class="container">
				...
				<div class="section-header">
					...
					<p>Today still wanted they surv soldiers </p>
				</div><!-- Section Header /- -->
				<div class="row">
					<form method="post"  action="/contactmail" class="col-md-12 contact-form no-padding">
                        {{csrf_field()}}
						...
						<div class="col-md-12 col-sm-12 col-xs-12 form-group">
							<textarea id="textarea_message" class="form-control" rows="5" name="content" placeholder="your mesage" required ></textarea>
						</div>
